		...
		init: function() {
			...
			this.getModel().read("/IssueTypeSet", {
				success: function(oData) {
					//console.log(oData);
					oComponent.setModel(oData, "issueType");
				}
			});

			this.getModel().read("/IssueModuleSet", {
				success: function(oData) {
					console.log(oData);
					oComponent.setModel(oData, "issueModule");
				}
			});

			this.getModel().read("/statusTextSet", {
				success: function(oData) {
					//console.log(oData);
					oComponent.setModel(oData, "statusText");
				}
			});
